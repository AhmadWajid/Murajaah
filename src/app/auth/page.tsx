...
export default function AuthPage() {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // For OAuth, the redirect is handled by the redirectTo option
      // but we can also add a fallback redirect here
      if (data) {
        // OAuth redirect should happen automatically, but we can add a fallback
        setTimeout(() => {
          router.push('/');
        }, 1000);
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">MQuran</h1>
          <p className="text-gray-600">Sign in to sync your Quran memorization progress</p>
        </div>
