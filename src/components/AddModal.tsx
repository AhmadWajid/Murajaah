...
export default function AddModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 dark:bg-gray-800/95 rounded-3xl p-8 w-full max-w-2xl shadow-2xl border border-border backdrop-blur-sm max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2 max-h-40 overflow-y-auto">
            {selections.map((selection, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-accent/8 rounded-[var(--radius)] border border-border">
        ...
        {mode === 'complex' && (
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-border bg-input text-foreground focus:outline-none focus:ring-2 focus:ring-ring/30"
                >
                  {surahList.map(surah => (
            ...
            <button
              ...
              className="w-full py-2 px-4 bg-primary hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground text-primary-foreground rounded-[var(--radius-sm)] font-medium transition-colors disabled:cursor-not-allowed"
            >
              Add Range
            </button>
          </div>
        ...
        <div className="space-y-4 mb-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-[var(--radius)] border border-border bg-input text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/30 focus:border-transparent"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-3 rounded-[var(--radius)] border border-border bg-input text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/30 focus:border-transparent resize-none"
            />
          </div>
        </div>
