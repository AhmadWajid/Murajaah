    ...
    <div className="text-right mb-4 sm:mb-6 px-1 sm:px-0 overflow-visible">
      {shouldShowHidden ? (
        <div className="flex flex-col items-center justify-center gap-3 py-8 sm:py-10">
          <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-[var(--radius)] bg-warning/8 border border-warning/15 text-warning">
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
            </svg>
            <span className="text-xs font-semibold tracking-wide font-sans">Hidden — test your memory</span>
          </div>
          <button
            onClick={(e) => {
              e.stopPropagation();
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-[var(--radius-sm)] bg-accent/10 hover:bg-accent/15 border border-accent/20 text-accent text-xs font-semibold transition-colors font-sans"
          >
